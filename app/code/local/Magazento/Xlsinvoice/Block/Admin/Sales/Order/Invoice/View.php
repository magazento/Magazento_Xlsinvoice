 ...
 */
class Magazento_Xlsinvoice_Block_Admin_Sales_Order_Invoice_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Admin session
     *
    ...
    public function __construct()
    {
        ...
        // MAGAZENTO.COM
        $xlsurl = $this->getUrl('xlsinvoice/admin_invoice/printxls', array('invoice_id'=>$this->getInvoice()->getId()));
        if ($this->getInvoice()->getId()) {
