 ...
 */
class Magazento_Xlsinvoice_Block_Admin_Sales_Order_Shipment_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        // MAGAZENTO.COM
        $xlsurl = $this->getUrl('xlsinvoice/admin_shipment/printxls', array('shipment_id'=>$this->getShipment()->getId()));
        if ($this->getShipment()->getId()) {
